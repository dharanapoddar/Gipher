...
import com.stackroute.accountmanager.model.JwtRequest;
import com.stackroute.accountmanager.model.JwtResponse;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> saveUser(@RequestBody UserDTO user) throws Exception {
		...
		try {
			...
			responseEntity = new ResponseEntity<DAOUser>(newUser, HttpStatus.OK);
	...
	public ResponseEntity<Object> isUserAuthenticated() {
		System.out.print("in isAuth");
		return ResponseEntity.ok(userDetailsService.isUserAuthenticated());
	}
